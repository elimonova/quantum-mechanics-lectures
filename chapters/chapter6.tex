...
Рассмотрим оператор $\op{G}$ с дискретным спектром:
...
Аналогия в классической механике --- канонические преобразования (см.~\llref{45}{1}).
...
$\op{U}(t)$ --- оператор эволюции. Из вышеприведённой формулы видно, что он является унитарным.
